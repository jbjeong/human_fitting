...
#        body_pose_3d, min_errors_body  = get_pose_3d(
#            body_keypts_list, P_list)
#        face_pose_3d, min_errors_face = get_pose_3d(
#            face_keypts_list, P_list)
#        hand_left_pose_3d, min_errors_left = get_pose_3d(
#            hand_left_keypts_list, P_list, wrist_point=body_pose_3d[7])
#        hand_right_pose_3d, min_errors_right = get_pose_3d(
#            hand_right_keypts_list, P_list, wrist_point=body_pose_3d[4])

#        s = time.time()
#        body_pose_3d, min_errors_body  = get_pose_3d_two_view_mean_error(
#            body_keypts_list, P_list)
#        e = time.time()
#        print(f'elp body: {e - s:3f}')
#        face_pose_3d, min_errors_face = get_pose_3d_two_view_mean_error(
#            face_keypts_list, P_list)
#        e2 = time.time()
#        print(f'elp face: {e2 - e:3f}')
#        hand_left_pose_3d, min_errors_left = get_pose_3d_two_view_mean_error(
#            hand_left_keypts_list, P_list, wrist_point=body_pose_3d[7], conf_thresh2=0.5)
#        e3 = time.time()
#        print(f'elp hand left: {e3 - e2:3f}')
#        hand_right_pose_3d, min_errors_right = get_pose_3d_two_view_mean_error(
#            hand_right_keypts_list, P_list, wrist_point=body_pose_3d[4], conf_thresh2=0.5)
#        e4 = time.time()
...
#        pose3d = np.load(save_path)
#        body_pose_3d = pose3d['body_pose_3d']
#        face_pose_3d = pose3d['face_pose_3d']
...
#        tmp_hand_left_pose = np.array(
#            [0.02304657, 0.26095556, 0.13517622])
#        hand_left_pose_3d, min_errors_left = get_pose_3d_two_view_ransac(
#            hand_left_keypts_list, P_list, wrist_point=tmp_hand_left_pose, conf_thresh2=0.5)
#        tmp_hand_right_pose = np.array(
#            [-0.13899016, 0.12469889, 0.02211055])
#        hand_right_pose_3d, min_errors_right = get_pose_3d_two_view_ransac(
#            hand_right_keypts_list, P_list, wrist_point=tmp_hand_right_pose, conf_thresh2=0.5)
#        import pdb; pdb.set_trace()
...
#        body_pose_3d, min_errors_body  = get_pose_3d_v2(
#            body_keypts_list, P_list)
#        face_pose_3d, min_errors_face = get_pose_3d_v2(
#            face_keypts_list, P_list)
#        hand_left_pose_3d, min_errors_left = get_pose_3d_v2(
#            hand_left_keypts_list, P_list, wrist_point=body_pose_3d[7],
#            confidence_thresh=0.6)
#        hand_right_pose_3d, min_errors_right = get_pose_3d_v2(
#            hand_right_keypts_list, P_list, wrist_point=body_pose_3d[4],
#            confidence_thresh=0.6)

#        body_pose_3d, min_errors_body  = get_pose_3d_v3(
#            body_keypts_list, P_list)
#        face_pose_3d, min_errors_face = get_pose_3d_v3(
#            face_keypts_list, P_list)
#        hand_left_pose_3d, min_errors_left = get_pose_3d_v3(
#            hand_left_keypts_list, P_list, wrist_point=body_pose_3d[7],
#            confidence_thresh=0.5)
#        hand_right_pose_3d, min_errors_right = get_pose_3d_v3(
#            hand_right_keypts_list, P_list, wrist_point=body_pose_3d[4],
#            confidence_thresh=0.5)
...
#        mesh_path = f'mesh_data/{subj_name}_OBJ/{subj_name}_100k_textured.obj'
#        mesh = o3d.io.read_triangle_mesh(mesh_path)
#        mesh = preprocess(mesh)
#
#        vis_list = [mesh]
#        both_hand_pose_3d = np.concatenate([hand_left_pose_3d, hand_right_pose_3d])
#        for xyz in both_hand_pose_3d: 
...
#    for v_idx in range(len(image_path_list)):
#        image = cv2.imread(image_path_list[v_idx])
#        P = P_list[v_idx]
#        for xyz in pose_3d:
#            h_xyz = np.array([
#                xyz[0], xyz[1], xyz[2], 1])
#            proj_xy = P @ h_xyz  
#            proj_xy = proj_xy.reshape(-1)
#            x = int(round(proj_xy[0] / proj_xy[2]))
#            y = int(round(proj_xy[1] / proj_xy[2]))
#            cv2.circle(image, (x, y), 5, (0, 255, 0), -1)
#        cv2.imwrite(f'visualize_triangulation/{v_idx}.png', image)
