...
class skinDetector(object):
    ...
    #class constructor
    def __init__(self, imageName, save_path):
...
#show the images
        ...
        #save_path = self.image_path[:-4] + '_skin.png'
        self.write_image(image_mask, self.save_path)
...
#================================================================================================================================
    ...
    def write_image(self, image, save_path):
